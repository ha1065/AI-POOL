...
if 'resolution' in locals():
    #white_ball_initial_pos = (resolution + [table_margin + hole_radius, 0]) * [0.5, .9]
    resolution1 = np.array([table_margin+hole_radius+ball_radius,table_margin+hole_radius+ball_radius ])
    white_ball_initial_pos = resolution1 * [1, 1]
